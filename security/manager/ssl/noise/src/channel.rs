...
xpcchannel_impl!(Channel, XPCChannel);

impl From<Channel> for RefPtr<XPCChannel> {
    fn from(value: Channel) -> Self {
        XPCChannel::allocate(InitXPCChannel {
...
pub unsafe extern "C" fn ctap_cable_channel_constructor(
    ...
    let channel: RefPtr<XPCChannel> = Channel::default().into();
