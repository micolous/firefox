...
#ifndef _cable_discovery_h_
#define _cable_discovery_h_
...
extern "C" {
nsresult cable_discovery_params_constructor(REFNSIID iid, void** result);
nsresult cable_discovery_service_constructor(REFNSIID iid, void** result);
};

#endif  // _cable_discovery_h_
